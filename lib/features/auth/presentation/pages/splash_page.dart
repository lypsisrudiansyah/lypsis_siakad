                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: 40,
                        height: 40,
                        child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Colors.white.withAlpha(178)), strokeWidth: 3),
                      ),
                      Center(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            // Contoh penggunaan
                            // if (dataLocale != null) Text(dataLocale.login_completeProfileMsg),

                            // Contoh lain jika Anda ingin menampilkan deskripsi aplikasi yang sudah ditambahkan sebelumnya
                            // if (dataLocale != null && dataLocale.appDescription != null)
                            //   Text(dataLocale.appDescription!), // Pastikan appDescription ada di AppLocalizations

                            // Tombol untuk mengganti bahasa (contoh)
                            ElevatedButton(
                              onPressed: () {
                                // Ganti ke Bahasa Inggris
                                context.read<LocaleCubit>().changeLocale(const Locale('en'));
                              },
                              child: Text("Profile EN"), // Contoh fallback
                            ),
                            ElevatedButton(
                              onPressed: () {
