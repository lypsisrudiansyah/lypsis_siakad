...
class AuthRepositoryImpl implements AuthRepository {
  ...
  @override
  Future<Either<Failure, AuthUserModel?>> signIn({required String email, required String password}) async {
  ...
  @override
  Future<Either<Failure, AuthUserModel?>> getUserProfile(String authId) async {
    try {
